...
# Read SW values and accuracy values
#sw_values = read_values_from_file('avgSW.txt')
cLayer1 = read_values_from_file('./C1.txt')
lLayer1 = read_values_from_file('./L1.txt')
cLayer2 = read_values_from_file('./C2.txt')
lLayer2 = read_values_from_file('./L2.txt')
cLayer3 = read_values_from_file('./C3.txt')
lLayer3 = read_values_from_file('./L3.txt')
accuracy_values = read_values_from_file('netAcc.txt')

#Plotting
plt.figure(figsize=(10, 6))
plt.scatter(cLayer1, accuracy_values, color='blue', alpha=0.5)
plt.title('Scatter Plot of Accuracy vs. Clustering coeff of Layer 1')
plt.xlabel('Clustering Coeff')
plt.ylabel('Accuracy')
plt.grid(True)
plt.savefig('accuracy_vs_cc_plot_layer1.pdf')

plt.figure(figsize=(10, 6))
plt.scatter(cLayer2, accuracy_values, color='blue', alpha=0.5)
plt.title('Scatter Plot of Accuracy vs. Clustering coeff of Layer 2')
plt.xlabel('Clustering Coeff')
plt.ylabel('Accuracy')
plt.grid(True)
plt.savefig('accuracy_vs_cc_plot_layer2.pdf')

plt.figure(figsize=(10, 6))
plt.scatter(cLayer3, accuracy_values, color='blue', alpha=0.5)
plt.title('Scatter Plot of Accuracy vs. Clustering coeff of Layer 3')
plt.xlabel('Clustering Coeff')
plt.ylabel('Accuracy')
plt.grid(True)
plt.savefig('accuracy_vs_cc_plot_layer3.pdf')

plt.figure(figsize=(10, 6))
plt.scatter(lLayer1, accuracy_values, color='blue', alpha=0.5)
plt.title('Scatter Plot of Accuracy vs. Average Path Length of Layer 1')
plt.xlabel('Average Path Length')
plt.ylabel('Accuracy')
plt.grid(True)
plt.savefig('accuracy_vs_apl_plot_layer1.pdf')

plt.figure(figsize=(10, 6))
plt.scatter(lLayer2, accuracy_values, color='blue', alpha=0.5)
plt.title('Scatter Plot of Accuracy vs. Average Path Length of Layer 2')
plt.xlabel('Average Path Length')
plt.ylabel('Accuracy')
plt.grid(True)
plt.savefig('accuracy_vs_apl_plot_layer2.pdf')

plt.figure(figsize=(10, 6))
plt.scatter(lLayer3, accuracy_values, color='blue', alpha=0.5)
plt.title('Scatter Plot of Accuracy vs. Average Path Length of Layer 3')
plt.xlabel('Average Path Length')
plt.ylabel('Accuracy')
plt.grid(True)
plt.savefig('accuracy_vs_apl_plot_layer3.pdf')
